...
- Name: responsive-matrix.spec.ts >> compact viewport (1024x768) >> library and workspace fit without overflow and keep 44px targets
- Location: e2e/responsive-matrix.spec.ts:19:5
...
Locator: getByRole('heading', { name: 'Ваше обучение' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Ваше обучение' })
