...
- main:
  ...
  - region "Подстроим курс под вас":
    ...
    - textbox "Какой результат нужен?": Write and verify small pure functions against published integer cases.
    - paragraph: Что вы хотите уметь делать после курса.
    - text: Навык
    - 'button "Подсказка: Навык"': "?"
    - text: из вашего описания
    - textbox "Навык": Python functions checked by integer cases
    ...
    - combobox "Ваш опыт":
      - option "—"
      - option "Начинаю с нуля"
      - option "Есть небольшой опыт" [selected]
    ...
    - text: из вашего описания
    - spinbutton "Время в неделю, часов": "9"
    - button "5"
    - button "10"
    - button "20"
    - button "40"
    ...
    - text: из вашего описания
    - spinbutton "На сколько недель?": "39"
    - button "1"
    - button "2"
    - button "4"
