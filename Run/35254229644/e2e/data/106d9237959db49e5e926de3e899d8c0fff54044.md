...
- Name: mentor.spec.ts >> compact viewport keeps exactly three global choices and 44px Support targets
- Location: e2e/mentor.spec.ts:144:1
...
Locator: getByRole('heading', { name: 'Tech Course', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Tech Course', exact: true })
