...
- Name: accessibility.spec.ts >> axe-core: course library page has zero accessibility violations
- Location: e2e/accessibility.spec.ts:121:1
...
Call log:
  ...
  - waiting for getByText('Tech Course')
