...
- Name: mentor.spec.ts >> context chips follow the workspace Theory, Quiz and Practice tabs
- Location: e2e/mentor.spec.ts:77:1
...
Locator: getByRole('heading', { name: 'Mentor Mixed Course', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Mentor Mixed Course', exact: true })
