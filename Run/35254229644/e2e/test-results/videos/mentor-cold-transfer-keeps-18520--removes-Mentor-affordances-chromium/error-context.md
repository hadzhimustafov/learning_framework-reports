...
- Name: mentor.spec.ts >> cold transfer keeps Rubric selected and removes Mentor affordances
- Location: e2e/mentor.spec.ts:91:1
...
Locator: getByRole('heading', { name: 'Cold Transfer Course', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Cold Transfer Course', exact: true })
