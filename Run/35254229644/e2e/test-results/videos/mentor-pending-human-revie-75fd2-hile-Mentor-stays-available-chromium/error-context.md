...
- Name: mentor.spec.ts >> pending human review suppresses Check and Next while Mentor stays available
- Location: e2e/mentor.spec.ts:105:1
...
Locator: getByRole('heading', { name: 'Review Course', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Review Course', exact: true })
