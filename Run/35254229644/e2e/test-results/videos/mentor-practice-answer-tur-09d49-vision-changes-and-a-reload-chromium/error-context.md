...
- Name: mentor.spec.ts >> practice answer turns stale after the workspace revision changes and a reload
- Location: e2e/mentor.spec.ts:261:1
...
Locator: getByRole('heading', { name: 'Mentor Course', exact: true })
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Mentor Course', exact: true })
